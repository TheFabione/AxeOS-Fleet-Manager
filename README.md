...
![Version](https://img.shields.io/badge/version-1.6.7-C8F73A) ![Manifest](https://img.shields.io/badge/Manifest-V3-blue) ![Devices](https://img.shields.io/badge/devices-BitAxe%20%7C%20NerdQAxe-8B5CF6)
...
- **Custom device icons** - pick one of 10 icons per device, or keep the type default
...
- **Two finished themes** - **Neon Vault** and **Aurora** (both dark)
